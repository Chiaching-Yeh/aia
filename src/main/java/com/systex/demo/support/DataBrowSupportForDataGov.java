...
public final class DataBrowSupportForDataGov {
...
//			} else 
			...
			if (punit1 != null && !"null".equals(punit1) && !"".equals(punit1)) {
				...
				punitsql = " and D1.PubUnitDN like :ary_punit1";
			...
			if (brows.equals("1")) {
				...
				if (punit2 != null && !"null".equals(punit2) && !"".equals(punit2)) {
					...
					punitsql = " and D1.PubUnitDN like :ary_punit2";

				}
			} else if (brows.equals("3")) {

				punitsql = " and D1.CreateUid = :muid";
