...
public class TrustManagerDelegateSupport implements X509TrustManager {
  
   private final X509TrustManager mainTrustManager;
   private final X509TrustManager fallbackTrustManager;
   
   public TrustManagerDelegateSupport(X509TrustManager mainTrustManager, X509TrustManager fallbackTrustManager) {
